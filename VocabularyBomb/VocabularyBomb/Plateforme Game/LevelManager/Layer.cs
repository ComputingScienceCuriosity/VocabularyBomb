...
namespace Vocabulary
{
    class Layer
    {
        public Texture2D[] Textures { get; private set; } // stores the backgroun textures, and its scrolling speed
        ...
        //this loads in the 3 textures and then sets its scroll speed
