...
using Microsoft.Xna.Framework.Audio;    //Adding this allows this class to have sound
namespace Vocabulary
{
    ...
    class Enemy
    {
        ...
        {
            // Load animations.
            spriteSet = "Plateforme/Sprites/" + spriteSet + "/";
            ...
            //Load sounds.
            killedSound = Level.Content.Load<SoundEffect>("Sounds/Triggers/ennemyDead");
        ...
        {
            IsAlive = false;
            killedSound.Play(); // once player is dead, play the killed sound for enemy
        }
